...
export type UpdatePublishedContentRequest = components["schemas"]["UpdatePublishedContentRequest"];
...
export type PublishQuestionRequest = components["schemas"]["PublishQuestionRequest"];
export type QuestionPublicationView = components["schemas"]["QuestionPublicationView"];
...
export type CandidateQuestionGenerationRequest = components["schemas"]["CandidateQuestionGenerationRequest"];
