...
<style scoped>
.document-management-panel{display:grid;gap:16px}.section-heading,.toolbar,.form-actions{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap}.section-heading h2{margin:0 0 5px}.document-table{display:grid;gap:10px}.document-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:start;padding:14px;border:1px solid #dce5de;border-radius:12px;background:#fff}.document-main{min-width:0}.document-main strong{overflow-wrap:anywhere}.document-main p{margin:5px 0 0;font-size:12px}.document-actions{grid-column:1 / -1;display:flex;align-items:center;justify-content:flex-end;gap:6px 10px;flex-wrap:wrap;padding-top:8px;border-top:1px solid #edf2ee}.text-button{min-height:30px;width:auto;margin-top:0;padding:5px 8px;border:0;background:transparent;color:#146b4a;white-space:nowrap}.text-button.danger,.button.danger{color:#b42318}.file-button,.file-button input,.document-actions label input{position:relative;overflow:hidden}.file-button input,.document-actions label input{position:absolute;width:1px;height:1px;opacity:0}.document-editor{grid-column:1 / -1;display:grid;gap:12px}.editor-card{padding:14px;border:1px solid #dce5de;border-radius:12px;background:#fbfdfb}.editor-card label{display:grid;gap:6px;color:#314d40;font-weight:800}.editor-card input,.editor-card textarea{width:100%;box-sizing:border-box;padding:9px 10px;border:1px solid #cbd8cf;border-radius:9px;background:#fff;font:inherit}.editor-card textarea{resize:vertical}.empty-hint{padding:20px;border:1px dashed #cbd8cf;border-radius:12px;color:#66736b}.error-text{color:#b42318}.tag.warning{background:#fff0cc;color:#865a18}
